...
3. Select the **`gh-pages`** branch and the **`/(root)`** directory as pictured below:

![](https://raw.githubusercontent.com/fastai/fastpages/master/_fastpages_docs/_gh_pages_branch.png)
